...
var App = function () {
  ...
  // ==================
      _baseInit = function (next) {
        ...
        process.stdout.write("***BASE init: ");
        init.init(this, next);
      }
  ...
  // ================================================
    , _afterStart = function (next) {
        ...
        console.log('*** RUNNING after_start');
  ...
  this.handleControllerAction = function (controllerInst, reqUrl, method,
    ...
    console.log('**** handleControllerAction: ' + reqUrl + ' | ' + method);
    ...
    console.log('**** this.handleControllerAction BEFORE initKeys');
    ...
    console.log('**** this.handleControllerAction AFTER initKeys');
  };
  ...
  this.start = function (callback) {
    ...
    geddy.server.addListener('request', function (req, resp) {
      ...
      dmn.run(function () {
        ...
        // console.log('****REQUEST: ' + reqUrl + ' | ' + urlParams + ' | ' + method + ' | ' + accessTime);
        ...
        if (params) {
          ...
          if (controllerInst) {
            ...
            if (typeof controllerInst[params.action] == 'function') {
              console.log('\n\n');
              console.log('****----------------(index.js) geddy.server.addListener(request...)--------------------****');
              console.log('****----------------if (typeof controllerInst[params.action] == \'function\')--------------------****');
              console.log('**** ' + params.controller + ' | ' + method + ' | ' + reqUrl);
